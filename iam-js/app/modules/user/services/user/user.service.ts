...
export class UserService {
    ...
    async update(id: number, dto: UpdateUserDto): Promise<User> {
        ...
        if (dto.firstName) dto.firstName = this.trimAndcapitalizeFirstLetter(dto.firstName);
        if (dto.lastName) dto.lastName = this.trimAndcapitalizeFirstLetter(dto.lastName);
