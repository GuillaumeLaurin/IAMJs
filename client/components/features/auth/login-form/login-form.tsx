...
export default function LoginForm() {
  ...
  const loginSchema = z.object({
    email: z.email("format de l'email invalide").min(1, v('emailRequired')),
    password: z.string().min(1, v('passwordRequired')).regex(PASSWORD_REGEX, v('passwordInvalid')),
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h3 className="font-heading text-2xl font-bold text-slate-900 mb-2">{t('title')}</h3>
